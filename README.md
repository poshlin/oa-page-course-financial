...
| 頁面聲稱 | 來源 |
|---|---|
| **平台實錄影片 ×5**（`assets/vid-*.mp4`＋poster） | 2026-08-18 由本對話直接驅動已登入的 staging Chrome 錄製（全程未輸入帳密），ffmpeg 裁切內容區。單檔 28–183KB、合計 ~890KB；VideoObject schema ×5 同步（contentUrl 暫指 GitHub Pages，**部署正式站時要跟 og:image 一起改回**）。錄製過程實際操作了平台：存款 11,000（儲蓄 $1,001→$12,001）、簽到 +1,600、命運卡 +3,000——**皆為模擬金幣**。🔴 誤刪教訓：清孤兒資產前必先 grep 引用 |
