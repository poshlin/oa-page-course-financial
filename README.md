...
| **45 堂完整課表**（堂次、課名、每堂說明） | `course-outline.md` §二／三／四，逐堂抽自教學部三份課程概要 PDF。⚠️ 課表上線後，04 區原本的「正式課前三堂」卡片與關卡名標籤已移除（與 02 課表、與 04 自己的課程地圖三重重複，2026-08-13） |
...
| 疑問句卡 8 題所標堂次（第 9/11/14/18/19/34/40/41 堂） | `course-outline.md` 對應堂次的教學點：尾數 9 定價、免費的商業模式、機率型商品的賭博性質、金錢往來與友誼、循環利息陷阱、隨意印鈔導致惡性通膨、蘇伊士運河事件、鬱金香狂熱。**張數固定 8 張**——`.qs` 排 4／2／1 欄，8 張才排得滿整列（6 張在桌機會變成 4+2 缺角）；要增減請以 4 的倍數為準 |
