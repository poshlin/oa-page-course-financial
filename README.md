...
**2026-08-18 微調：`shot-map` 由 04 移到 02 結尾**（保旭拍板）。實測手機文字／圖片分布，第 4–9 螢幕連續六個螢幕零張圖、第一張實拍在第 9.2 螢幕。把關卡地圖移到 02 結尾後，沙漠縮到第 4–6 螢幕、地圖落在第 6.7 螢幕，並緊接第 7.3 的課表 CTA。

- **定位是「過場」不是「內容搬家」**：它在 02 的功能是把「45 堂」從一份清單接到「每一堂長什麼樣」，再交棒給 03／04。放結尾而非開頭，就不會擠掉 02 的開場主張。
- **與原則 2 不衝突**：原則講的是「平台作為產品的敘事只能有一段」，不是「平台的任何像素」。04 本來就有平台擷取；關卡地圖上的節點是小故事／小知識／小測驗／小遊戲／小議題＝教學法，不是產品功能。
- 04 導言同步改寫為承接課程影片（原本是為了帶出地圖）。

**2026-09-03 章節換位：03「一堂課怎麼上」移到 02「學什麼」之前**（保旭拍板）。新順序：01 為什麼需要 → **02 一堂課怎麼上** → **03 學什麼（45 堂）** → 04 孩子怎麼學 → 05 課後練習場 → …

- **三條原則一條都沒違反**：45 堂課表仍在平台內容（05）之前 ✓；平台仍只有一段且在課程之後 ✓；課表（現 03）仍在「孩子怎麼學」（04）之前 ✓
- **理由是量出來的**：換位前第一張「人」的視覺在第 8.3 螢幕，換位後老師照片落在 **4.8 螢幕**；前六個螢幕從「4、5、6 連續零圖」變成**全部有圖**。零圖區被推到第 7–8 螢幕，已過決策點
- **敘事反而更順**：01 收在「我們給孩子一個『會發生後果』的世界」，接「一堂課怎麼上」是直接回答，比接一份 45 堂清單更貼
- 連帶改動：kicker 編號、浮動索引順序、`loop` 底色由 syllabus 移到 class（維持交錯節奏）
...
| 頁面聲稱 | 來源 |
|---|---|
| **學習週報影片**（`vid-report`，10s／79KB） | 2026-08-18 改為**三段定格淡接**（非錄影，由三張截圖合成）。原因：週報頁 14,482px 有 86% 是 179 個學習單元的清單，整頁捲動既無聊又讀不到東西。三段對齊章節文案的三個賣點：本週摘要＋親子建議／上課進度（5.7 天活躍、+8,700 經驗、179 單元）／理財狀況（總資產 43,460、收支明細）。**皆為測試帳號「小明」的模擬金幣** |
| **實拍照片 ×5**（`assets/photo-*.webp`） | 2026-09-03 保旭提供。①`photo-teacher`＝**線上課頁 `/campaigns/online/` hero 影片第 16 秒抽幀**（老師戴耳麥、對筆電授課）。該老師為財商課程設計者，但**班級眾多、實際授課老師高機率不是他**，故圖說明載「實際授課老師依班級安排」——🔴 不得寫成「由這位老師授課」。②③④⑤＝同仁的孩子**在家中**以平板操作平台（非營隊現場，圖說不得寫營隊）；**已取得肖像授權同意書**，畫面無正臉。⚠️ 這批照片同時是**平板可用的依據**（保旭 2026-09-03 確認平板 OK，先前 9/1 前的「頁面不得出現平板」限制解除）。附帶收穫：`photo-story` 螢幕顯示「第 1 課：古代貨幣」，證實**平台編號已修正**（體驗課不再佔第 1 課）；`photo-quiz` 顯示「第 5 課：家庭支出的選擇」，與頁面課表第 5 堂完全一致 |
| **排行榜實拍**（`shot-rank.webp`） | 2026-08-19 由本對話擷取平台 `/ranking`。**保旭確認畫面中的名字皆為內部人員、非學生**，故可公開。這張圖是頁面「比的是這期進步多少，不是誰的錢多」唯一的硬證據：**第 6 名總資產 123,101，比第 2 名的 49,621 多一倍以上，卻排在後面**，因為排序依「本月新增」。取代原本的 CSS 頒獎台（只有 1/2/3 三個方塊，證明不了這件事）|
| **設備需求：平板（iPad）可用、純觸控、Android 不支援** | 知識庫 `OA_課程體系.md` 招生通則第 3 條（2026-08-25 保旭更正、**對外 2026-09-01 生效**）：「正式課可用平板：頑皮艾伯特、橘蘋麥思、**財商**」；周邊需求（2026-09-02 保旭確認）「三課用平板**可純觸控上課，不強制外接鍵盤滑鼠**」。Android 禁用依記憶 `project_oa_device_specs`。🔴 **2026-09-03 獨立稽核抓到：頁面 FAQ 原本寫「用筆電或桌機＋滑鼠」，是被 9/1 政策取代的舊規格（沿自 `research/course-outline.md`），而且與本頁四張平板照片自相矛盾**，已修正 |
...
| **平台實拍截圖**（`assets/shot-*.webp`） | 2026-08-17 由影片對話在 staging 擷取（`~/Downloads/oa-coin-quest-video/capture/stills/`），帳號「小明」、乾淨無瀏覽器外框。🔴 **這是頁面上第一批真實產品畫面**，此前所有平台畫面都是我用 CSS 造的 mockup。`shot-map`＝**「體驗課：支出與公益」18 關**（2026-08-18 由本對話直接操作已登入 Chrome 擷取，取代原第 1 堂版本——家長看到的地圖就是試聽當天那一堂）；~~`shot-invest`~~（**2026-08-18 已由 `vid-invest` 影片取代並移出 assets**，原圖是零持股狀態）；`shot-savings`＝銀行儲蓄（畫面自帶「每雙週利率為 0.1%」＝頁面宣稱的視覺證據）；`shot-insurance`＝**3×2 六張保單並列**（意外/醫療/住宅/租客/汽車責任/汽車車體，各帶理賠金額；2026-08-18 由單張醫療險特寫改版——原圖比例 1.12 撐高整條滑動列，且文案寫「9 種」圖只有 1 種。醫療險 $3,000 仍在畫面內，命運卡敘事不受影響）；`shot-checkin`／`shot-stagemap` 備用未上頁。🔴 商城卡**刻意不換**——現有三張造型（含價格與等級門檻）已是真素材且銷售資訊更強；等級條在 333px 流程卡內文字不可讀，亦不放 |
| hero mockup 的資產數值（51,021／可用現金 38%／投資理財 38%／銀行儲蓄 24%／持有保險 9 張／日薪 1,600／排名 2） | 2026-08-18 平台首頁實測快照（`capture/stills_raw/dash_raw.png`）。**刻意採用這個時間點**：先前 8/17 快照是可用現金 98%、投資 $0，圓環單色且等於展示一個沒在用產品的學生。⚠️ **今日任務三項仍沿用 8/17 那組**（每日測驗／查看可用現金明細／完成一堂課程）——8/18 當天的任務列是「買賣任一股票 +500」，與第 30 堂「長期持有、定期定額」自相矛盾（家長稽核既有判定）。今日任務每天輪替，兩者皆為真實出現過的畫面 |
